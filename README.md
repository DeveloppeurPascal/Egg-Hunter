...
You have to harvest their eggs, incubate them until they hatch, and explode production quotas (just for fun).

To download the game and find out more, visit [the Egg Hunter website](http://egghunter.gamolf.fr).

This game was developed in Delphi [live on Twitch](https://www.twitch.tv/patrickpremartin). Most of the coding sessions are available as replays (in French) on [the Egg Hunter dedicated page](https://serialstreameur.fr/jv-egg-hunter.php) on [the VOD site Serial Streameur](https://serialstreameur.fr/).

This code repository contains a project developed in Object Pascal language under Delphi. You don't know what Delphi is and where to download it ? You'll learn more [on this web site](https://delphi-resources.developpeur-pascal.fr/).

## Using this video game

Visit [the Egg Hunter website](https://egghunter.gamolf.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/Egg-Hunter).
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/Egg-Hunter) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://egghunter.gamolf.fr) or [the project devlog](https://developpeur-pascal.fr/egg-hunter.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/Egg-Hunter/issues) so that I can test and try to correct or provide a workaround.
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/Egg-Hunter) and [open a new issue](https://github.com/DeveloppeurPascal/Egg-Hunter/issues).
